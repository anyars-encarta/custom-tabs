...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/custom-tabs.JPG" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Custom Tabs</b></h3>
...
<!-- INTRO -->
# 📖 Custom Tabs<a name="about-project"></a>

> Custom Tabs is an interactive app that changes the information on the UI based on the tab selected. The background color of the selected tab is also changed.
...
> - Change the data on the UI based on selected tab.
...
```sh
cd custom-tabs
https://github.com/anyars-encarta/custom-tabs.git
```
